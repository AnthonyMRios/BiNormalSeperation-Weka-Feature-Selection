 ...
 */
public class BiNormalSeperationEvalTest 
  extends AbstractEvaluatorTest {

  public BiNormalSeperationEvalTest(String name) { 
    super(name);  
  }
  ...
  public ASEvaluation getEvaluator() {
    return new BiNormalSeperationEval();
  }

  public static Test suite() {
    return new TestSuite(BiNormalSeperationEvalTest.class);
  }
